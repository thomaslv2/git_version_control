...
class Team(models.Model):
    ...
    nginxhost = models.ManyToManyField('Host', verbose_name='nginx机器',related_name="nginxhost")
    nginxconf = models.CharField(verbose_name='nginx配置文件', max_length=200, null=True, blank=True)
    host = models.ManyToManyField('Host', verbose_name='后端主机',related_name="host")
...
class Host(models.Model):
    ...
    settings = models.CharField(verbose_name='环境',choices=Seetings,default="3", max_length=20)
